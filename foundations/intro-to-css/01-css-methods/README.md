...
- Does the `div` element have CSS added via the external method? - No, I used inline
- Does the `p` element have CSS added via the internal method? - No, I used internal
- Does the `button` element have CSS added via the inline method? - No, I used external
